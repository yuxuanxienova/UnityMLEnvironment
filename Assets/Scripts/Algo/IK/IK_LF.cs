...
public class IK_LF : MonoBehaviour
{
    // public GameObject baseInertiaObj;
    // public GameObject endEffectorObj;
    // public ArticulationBody articulationBody_LF_HIP;
    // public ArticulationBody articulationBody_LF_THIGH;
    // public ArticulationBody articulationBody_LF_SHANK;
    ...
    void Start()
    {
        // articulationBody_LF_HIP.SetDriveForceLimit(ArticulationDriveAxis.X,80f);
        // articulationBody_LF_THIGH.SetDriveForceLimit(ArticulationDriveAxis.X,80f);
        // articulationBody_LF_SHANK.SetDriveForceLimit(ArticulationDriveAxis.X,80f);
    ...
    void Update()
    {
        ...
        // articulationBody_LF_HIP.SetDriveTarget(ArticulationDriveAxis.X,gamma_deg);
        // articulationBody_LF_THIGH.SetDriveTarget(ArticulationDriveAxis.X,alpha_deg);
        // articulationBody_LF_SHANK.SetDriveTarget(ArticulationDriveAxis.X,beta_deg);
