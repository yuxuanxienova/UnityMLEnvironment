...
public class IK_RH : MonoBehaviour
{
    // public GameObject baseInertiaObj;
    // public ArticulationBody articulationBody_RH_HIP;
    // public ArticulationBody articulationBody_RH_THIGH;
    // public ArticulationBody articulationBody_RH_SHANK;
    ...
    void Start()
    {
        // articulationBody_RH_HIP.SetDriveForceLimit(ArticulationDriveAxis.X,80f);
        // articulationBody_RH_THIGH.SetDriveForceLimit(ArticulationDriveAxis.X,80f);
        // articulationBody_RH_SHANK.SetDriveForceLimit(ArticulationDriveAxis.X,80f);
    ...
    void Update()
    {
        ...
        // articulationBody_RH_HIP.SetDriveTarget(ArticulationDriveAxis.X,gamma_deg);
        // articulationBody_RH_THIGH.SetDriveTarget(ArticulationDriveAxis.X,alpha_deg);
        // articulationBody_RH_SHANK.SetDriveTarget(ArticulationDriveAxis.X,beta_deg);
