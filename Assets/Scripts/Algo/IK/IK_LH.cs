...
public class IK_LH : MonoBehaviour
{
    // public GameObject baseInertiaObj;
    // public GameObject endEffectorObj;
    // public ArticulationBody articulationBody_LH_HIP;
    // public ArticulationBody articulationBody_LH_THIGH;
    // public ArticulationBody articulationBody_LH_SHANK;
    ...
    void Start()
    {
        // articulationBody_LH_HIP.SetDriveForceLimit(ArticulationDriveAxis.X,80f);
        // articulationBody_LH_THIGH.SetDriveForceLimit(ArticulationDriveAxis.X,80f);
        // articulationBody_LH_SHANK.SetDriveForceLimit(ArticulationDriveAxis.X,80f);
    ...
    void Update()
    {
        ...
        // articulationBody_LH_HIP.SetDriveTarget(ArticulationDriveAxis.X,gamma_deg);
        // articulationBody_LH_THIGH.SetDriveTarget(ArticulationDriveAxis.X,alpha_deg);
        // articulationBody_LH_SHANK.SetDriveTarget(ArticulationDriveAxis.X,beta_deg);
